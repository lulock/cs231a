...
class RandomHorizontalFlip(object):
    ...
    def __call__(self, sample):
        ...
        if random.random() < 0.5:
            img = None #TODO implement a left-right flip using PIL
            depth = None #TODO implement a left-right flip using PIL
...
class RandomChannelSwap(object):
    ...
    def __call__(self, sample):
        ...
        if random.random() < self.probability:
            ...
            image = None #TODO create a new PIL Image with one pair of channels swapped
...
class NYUDataset(Dataset):
    ...
    def __len__(self):
        return None #TODO correctly return length of dataset
